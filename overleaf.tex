...
\begin{lstlisting}[language=typescript, caption={Injetando \texttt{Disk} com \texttt{@inject()}}]
...
\begin{lstlisting}[language=typescript, caption={Trocando disk por \textit{fake} em testes}]
import drive from '@adonisjs/drive/services/main'
...
\begin{lstlisting}[language=typescript, caption={Ex.: provider mínimo com \texttt{register}/\texttt{boot}}]
import { ApplicationService } from '@adonisjs/core/types'
...
\begin{lstlisting}[language=typescript, caption={Acessando o contexto atual via ALS}]
import { HttpContext } from '@adonisjs/core/http'

export function useRequestId(): string | undefined {
const ctx = HttpContext.get() // contexto "da vez" (escopo de req)
...
\begin{lstlisting}[language=typescript, caption={Hash com config provider}]
